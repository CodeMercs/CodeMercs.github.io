...
function init() {
	...
	l1.load('img/file1.jpg', function(img) {
		slide.setImage(img);
	})
	...
	l2.load('img/file2.jpg', function(img) {
		slide2.setImage(img);
	})
...
function Slide(width, height, animationPhase) {
	...
	var material = new THREE.BAS.BasicAnimationMaterial({
		...
		shaderTransformPosition: [
			(animationPhase === 'in' ? 'transformed *= tProgress;' : 'transformed *= 1.0 - tProgress;'), 'transformed += cubicBezier(aStartPosition, aControl0, aControl1, aEndPosition, tProgress);'
		]
	}, {
